...
// var stream = request('URL.jpg');
// var writeStream = fs.createWriteStream('./check.jpg');
...
http.createServer(function(req, res) {
    ...
    // var URL = req.url;  // The URL is simple the local directory and tacks on the requested url
  
    var readStream = fs.createReadStream('./download.mp4'); // This line opens the file as a readable stream    fs.createReadStream('./1.jpg', {highWaterMark: 256});
                                                            // local directory file works with extension .mp4 .jpg etc
    // readStream.on('readable', function() {
    //     console.log('readable event occurred');
    // });
    readStream.on('open', function () {      // This will wait until we know the readable stream is actually valid before piping
