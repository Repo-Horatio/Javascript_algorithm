// Reference 
    ...
    var writeStream = fs.createWriteStream('./download.mp4');
    ...
    // stream.on('error', (err) => {
    //     console.log('error occurred while writing stream ');
    //     writeStream.close();
    // });
    ...
    http.createServer(function(req, res) {
        ...
        var readStream = fs.createReadStream('./download.mp4'); // This line opens the file on local directory as a readable stream    fs.createReadStream('./1.jpg', {highWaterMark: 256});
